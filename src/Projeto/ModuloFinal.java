        ...
        try{
            ...
            switch (choice) {
                case 1:
                    ...
                    B = myFilter.startBloom("C://Users//João Dias//eclipse-workspace//Projeto_mpei//src//Projeto//names.txt");
                    System.out.println("Bloom Iniciado, usa a opção (2) para verificar alguma palavra");
                    flagbloom = 1;
                    break;
                ...
                case 2:
                    if(flagbloom==1){
                        ...
                        System.out.println("Inicia primeiro o bloom. Opçãoo (1)");
                    }
                    break;
                ...
                case 3:
                    if(flagbloom==1){
                        ...
                        myFilter.checkSortudo("C://Users//João Dias//eclipse-workspace//Projeto_mpei//src//Projeto//names.txt", B);
                    }
                    else{
                ...
                case 5:;
                    if (flagcontador == 1) {
                        ...
                        sm1.readToMapaFinal("C://Users//João Dias//eclipse-workspace//Projeto_mpei//src//Projeto//LoteriaDataSet.csv");
